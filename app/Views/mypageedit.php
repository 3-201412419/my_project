            ...
            <form action="/mypage/update" method="post">
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        name="company_name"
                        class="form-control"
                        value="<?= esc($userData['company_name'] ?? '') ?>">
                </div>
                <div class="form-group">
                    ...
                    <input
                        ...
                        class="form-control"
                        value="<?= esc($userData['company_address'] ?? '') ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea
                        ...
                        class="form-control"><?= esc($userData['company_description'] ?? '') ?></textarea>
                </div>
                <div class="form-group">
